...
class MainUi(QtWidgets.QMainWindow):
    ...
    def init_ui(self):
        ...
        self.stackedWidget_func.setGeometry(QtCore.QRect(200, 500, 500, 50))
        self.stackedWidget_func.setStyleSheet("QWidget{background-color:rgb(255, 255, 255);border:none}")

        # 2.2 创建分页对象，并载入分页
        self.file_page = page2.DNA_Page()
        self.stackedWidget_func.addWidget(self.file_page)
        self.common_page = page2.RNA_Page()
        self.stackedWidget_func.addWidget(self.common_page)
        self.advance_page = page2.Protein_Page()
        self.stackedWidget_func.addWidget(self.advance_page)
        self.common_page = page2.IonTolerance_Page()
        self.stackedWidget_func.addWidget(self.common_page)
        self.advance_page = page2.Development_Page()
        self.stackedWidget_func.addWidget(self.advance_page)
